...
public class TACGenerator extends MiniJavaBaseVisitor<TACBlock> {
    ...
    public TACBlock visitExpBinOp(MiniJavaParser.ExpBinOpContext ctx) {
        ...
        result.addAll(expr1);
        result.addAll(expr2);
        result.add(TACOp.binop(this.genreg(), expr1.getResult(), expr2.getResult(), 2));
        return result;
    }
    ...
    // edited for (!=)
    private TACBlock generateNotEqual(TACBlock expr1, TACBlock expr2) {
        String labelEnd = this.genlab();
        String res = this.genreg();
        ...
        result.addAll(expr1);
        result.addAll(expr2);
        result.add(TACOp.binop(temp, expr2.getResult(), expr1.getResult(), TACOp.binopToCode("-")));
